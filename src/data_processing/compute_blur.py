...
feature_list = ['gradient_energy', 'kurt', 'tef', "variance_of_laplacian", "blurriness_fft", "blurriness_wavelet",
                "contrast_operator", "blurriness_steerable"]
...
def compute_blur_from_model(list_images_path, blur_artifacts_path):
    """
    ...
    blur_result_dict = {image_path: {"blur": y_predict} for image_path, y_predict in
                        zip(list_images_path, blur_predict)}
